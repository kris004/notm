...
- search/navigation: `focus_search`, `set_search_query`, `run_search`, `load_more_threads`, `scroll_thread_list_to_bottom`, `thread_page_info`, `thread_selection_view_state`, `thread_row_layout`, `thread_list_rows`, `select_saved_search`, `save_current_search`, `select_thread_by_index`, `select_relative_thread`, `select_thread_edge`, `open_selected_thread`, `select_message_by_index`, `thread_ui_details`, `toggle_multi_select_thread`, `clear_multi_selection`
...
- UI/debug: `open_command_palette`, `command_completion`, `open_shortcuts`, `show_shortcuts`, `help_search`, `run_command`, `run_manual_sync`, `open_settings`, `save_settings`, `resize_window`, `pane_visibility`, `set_pane_visibility`, `toggle_debug_panel`, custom saved-search and custom tag editor commands
